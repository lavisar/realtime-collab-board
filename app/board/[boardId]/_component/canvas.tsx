...
export const Canvas = ({ boardId }: CanvasProps) => {
	...
	const onResizeHandlePointerDown = useCallback(
		(corner: Side, inititalBounds: XYHW) => {
			// console.log({ corner, inititalBounds });
			history.pause();
			setCanvasState({
	...
	const onPointerMove = useMutation(
		({ setMyPresence }, e: React.PointerEvent) => {
			...
			if (canvasState.mode === CanvasMode.Pressing) {
				console.info(':::[Mode]:::PRESSING-[SELECTION NET]');
				startMultiSelection(current, canvasState.origin);
			} else if (canvasState.mode === CanvasMode.SelectionNet) {
				console.info(':::[Mode]:::PRESSING-[UPDATE SELECTION NET]');
				updateSelectionNet(current, canvasState.origin);
			} else if (canvasState.mode === CanvasMode.Translating) {
				console.info(':::[Mode]:::TRANSLATING');
				translateSelectedLayers(current);
			} else if (canvasState.mode === CanvasMode.Resizing) {
				console.info(':::[Mode]:::RESIZING');
